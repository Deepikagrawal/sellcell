...
<div style="background-image:url('image/cart1.png');background-size:100%;">
												...
												while ($row=mysqli_fetch_row($result))
													{
														...
														echo "<button type=\"submit\" id=\"top-icon\" name=\"add_to_cart\" class=\"glyphicon glyphicon-shopping-cart\" formaction=\"add_to_cart.php?pid=$pid\"></button>";
														echo "<button type=\"submit\" id=\"hand-icon\" name=\"remove_wish\" class=\"glyphicon glyphicon-remove\" formaction=\"wish.php?pid=$pid\"></button>";
														echo "<br>";
														echo "</form>";
  ...
  <p><?php
									...
									$sql="SELECT pname,price from wishlist where username='$username'";
									$price=0;
									$tax=0;
										if ($result=mysqli_query($con,$sql))
										{
