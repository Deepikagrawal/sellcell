...
<body>
<div style="background-image:url('image/checkout.jpg');background-size:100%;">
  <div class="header">
  	<h2>Checkout</h2>
										...
										if ($result=mysqli_query($con,$sql))
										{
												...
												while ($row=mysqli_fetch_row($result))
							
													{
														...
														echo "<button type=\"submit\" id=\"hand-icon\" name=\"remove_cart\" class=\"glyphicon glyphicon-remove\" formaction=\"checkout.php?pid=$pid\"></button>";
...
echo "<p style=\"text-align:center\">";
 ...
 echo 'No products to display';
	...
	$sql="SELECT price from cart where username='$username'";
										...
										if ($result=mysqli_query($con,$sql))
										{
											...
											printf ("%s <br>",$amount);
													...
													echo "<form method=\"post\" >";
										echo "<button formaction=\"shop.html\" class=\"add-btn\" >Add more products</button>";
										echo "<button class=\"add-btn\" formaction=\"confirm.php?amount=$amount\">Confirm your details</button>";
										echo "</form>";
										}
}
								echo "</div>";
	echo "<div class=\"col-sm-4\" id=\"amount-div\">";
	echo "<p class=\"checkout-final\">";
