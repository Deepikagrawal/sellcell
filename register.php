...
<div style="background-image:url('image/login.jpg');background-size:100%;text-align:center;">
  <div class="header">
  	<h2>Register</h2>
  ...
  <form method="post" action="register.php">
	...
	<div class="input-group1">
  	  ...
  	  <input type="text" name="address1" value="<?php echo $address1; ?>" placeholder="Address 1" required>
  	</div>
	<div class="input-group1">

  	  <input type="text" name="address2" value="<?php echo $address2; ?>" placeholder="Address 2">
  	</div>
	<div class="input-group1">
	...
	<div class="input-group1">
  	  ...
  	  <input type="text" name="pincode" value="<?php echo $pincode; ?>" placeholder="Pin Code" required>
  	</div>
	<div class="input-group1">
  	...
  	<p>
  		Already a member? <a href="login.php" id="login-link">Sign in</a>
  	</p>
  </form>
  </div>
<!--footer -->
